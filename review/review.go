...
func (w *Workflow) GenerateFinalSummaryPrompt() string {
	...
	sb.WriteString("   - Code: A GitHub-style diff block showing the changes needed\n\n")
	...
	sb.WriteString("   - **Code**:\n")
	sb.WriteString("   ```diff\n")
	sb.WriteString("   - // Code that should be removed or replaced\n")
	sb.WriteString("   + // New code that should be added\n")
	sb.WriteString("   ```\n\n")
